...
### Как тестировать
#### в браузере
- можнно в адресной строке набрать путь к файлу (при существующем ф будет показан этот файл, при несуществующем ф - 404) 
...
- слегка поправил new404 (картинки не стал, так как их будут искать в директории сервера)
